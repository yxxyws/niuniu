...
public class UIPopupList : UIWidgetContainer
{
	...
	{
		UIPopupList.<UpdateTweenPosition>c__Iterator0 <UpdateTweenPosition>c__Iterator = new UIPopupList.<UpdateTweenPosition>c__Iterator0();
		<UpdateTweenPosition>c__Iterator.$this = this;
	...
	protected virtual void OnNavigate(KeyCode key)
	{
		if (base.enabled && UIPopupList.current == this)
		{
			...
			{
				if (key == KeyCode.DownArrow && num + 1 < this.mLabelList.Count)
				{
					this.Select(this.mLabelList[num + 1], false);
				}
			}
	...
	{
		UIPopupList.<CloseIfUnselected>c__Iterator1 <CloseIfUnselected>c__Iterator = new UIPopupList.<CloseIfUnselected>c__Iterator1();
		<CloseIfUnselected>c__Iterator.$this = this;
