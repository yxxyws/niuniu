...
public class UIAnchor : MonoBehaviour
{
	...
	private void Update()
	{
		...
		if (this.side != UIAnchor.Side.Center)
		{
			...
			{
				if (this.side == UIAnchor.Side.Top || this.side == UIAnchor.Side.Center || this.side == UIAnchor.Side.Bottom)
				{
					vector.x = x;
				}
				else
			...
			{
				if (this.side == UIAnchor.Side.Left || this.side == UIAnchor.Side.Center || this.side == UIAnchor.Side.Right)
				{
					vector.y = y;
				}
				else
