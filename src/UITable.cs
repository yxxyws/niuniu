...
public class UITable : UIWidgetContainer
{
	...
	public List<Transform> GetChildList()
	{
		...
		if (this.sorting != UITable.Sorting.None)
		{
			...
			{
				if (this.sorting == UITable.Sorting.Horizontal)
				{
				...
				{
					if (this.sorting == UITable.Sorting.Vertical)
					{
	...
	protected void RepositionVariableSize(List<Transform> children)
	{
		...
		if (this.pivot != UIWidget.Pivot.TopLeft)
		{
			...
			for (int k = 0; k < transform3.childCount; k++)
			{
				...
				if (component != null)
				{
					SpringPosition expr_4A1_cp_0 = component;
					expr_4A1_cp_0.target.x = expr_4A1_cp_0.target.x - num7;
					SpringPosition expr_4B6_cp_0 = component;
					expr_4B6_cp_0.target.y = expr_4B6_cp_0.target.y - num8;
				}
				else
				{
