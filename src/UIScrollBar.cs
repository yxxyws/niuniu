...
public class UIScrollBar : UISlider
{
	...
	protected override void OnStart()
	{
		...
		if (this.mFG != null && this.mFG.gameObject != base.gameObject)
		{
			...
			UIEventListener expr_76 = uIEventListener;
			expr_76.onPress = (UIEventListener.BoolDelegate)Delegate.Combine(expr_76.onPress, new UIEventListener.BoolDelegate(base.OnPressForeground));
			UIEventListener expr_98 = uIEventListener;
			expr_98.onDrag = (UIEventListener.VectorDelegate)Delegate.Combine(expr_98.onDrag, new UIEventListener.VectorDelegate(base.OnDragForeground));
